...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/ABDIAS-TECH/IVORYX-XMD;
...
└──────────────────────┘
> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ ABDIAS-TECH*`;

        await conn.sendMessage(from, {
            image: { url: `https://files.catbox.moe/qfh46k.jpg ` },
            caption: message,
            contextInfo: { 
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: config.OWNER_NAME || 'ABDIAS-TECH,
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
